package com.wendaoren.springcloud.loadbalancer.autoconfigure;


import com.wendaoren.springcloud.loadbalancer.prop.SpringCloudLoadBalancerProperties;
import com.wendaoren.springcloud.loadbalancer.support.SpringCloudLoadBalancerClientConfiguration;
import com.wendaoren.springcloud.loadbalancer.support.hint.*;
import feign.Feign;
...
public class SpringCloudLoadBalancerAutoConfiguration {
    ...
    public static class SpringWebFluxConfiguration {
        ...
        @ConditionalOnMissingBean(name = "hintGatewayWebFilter",
                type = "com.wendaoren.springcloud.loadbalancer.support.hint.HintGatewayWebFilter")

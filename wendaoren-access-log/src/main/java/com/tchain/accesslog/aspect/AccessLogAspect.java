package com.tchain.accesslog.aspect;

import com.tchain.accesslog.annotation.AccessLog;
...
public class AccessLogAspect {
	...
	@Pointcut("@within(com.tchain.accesslog.annotation.AccessLog) || @annotation(com.tchain.accesslog.annotation.AccessLog)")
